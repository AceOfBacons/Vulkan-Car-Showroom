...
namespace lve {
	...
	{
		assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "cannot create graphcis pipeline:: no pipeline is provided in configInfo");
		assert(configInfo.renderPass != VK_NULL_HANDLE && "cannot create graphcis pipeline:: no renderPass is provided in configInfo");
